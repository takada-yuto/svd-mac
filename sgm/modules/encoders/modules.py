...
class FrozenT5Embedder(AbstractEmbModel):
    ...
    def __init__(
        self, version="google/t5-v1_1-xxl", device="mps", max_length=77, freeze=True
...
class FrozenByT5Embedder(AbstractEmbModel):
    ...
    def __init__(
        self, version="google/byt5-base", device="mps", max_length=77, freeze=True
    ):  # others are google/t5-v1_1-xl and google/t5-v1_1-xxl
        super().__init__()
...
class VideoPredictionEmbedderWithEncoder(AbstractEmbModel):
    ...
    def forward(
        ...
        with torch.autocast("mps", enabled=not self.disable_encoder_autocast):
            n_samples = (
